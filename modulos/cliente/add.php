...
if (isset($_SESSION["retroceso"])) {
  ?>
  <script>
    location.href = 'index.php?directorio=cliente&pagina=add.php';
  </script>
<?php
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-8 col-md-6">
            ...
            <input type="email" required class="form-control" id="correo" name="correo" maxlength="50   ">
            <ul id="mensajeError">
              <!--Mensaje si el correo existe -->
            </ul>
          ...
          <div class="col-sm-6 col-md-2">
            <label>Sexo</label><br>
            <input class="" type="radio" id="sexo" value="M" checked name="sexo"> Masculino
            <input class="ml-2" type="radio" id="sexo" value="F" name="sexo"> Femenino
          </div>
          <div class="col-sm-6 col-md-2">
