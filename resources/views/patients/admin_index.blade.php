                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">                     
                            <div class="form-group">
                                <label class="text-primary" for="province_id"  class="col-12"> {{ trans('patients/admin_lang.fields.province_id') }}</label>
                        ...
                        <div class="col-12 col-md-4">                     
                            <div class="form-group">
                                <label class="text-primary" for="municipio_id" class="col-12"> {{ trans('patients/admin_lang.fields.municipio_id') }} </label>
