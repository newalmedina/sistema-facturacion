        ...
        <form id="formData" enctype="multipart/form-data" action=" {{ route("admin.patients.clinicalRecordUpdate",$patient->id) }}  " method="post"  novalidate="false">
            ...
            <div class="card-body"> 
                ...
                <div class="row form-group mb-3">   
                    <div class="col-lg-12">                     
                        <div class="form-group">
                            <label for="allergies"> {{ trans('patients/admin_lang.fields.allergies') }}</label>
                ...
                <div class="row form-group mb-3">     
                    <div class="col-lg-12">                     
                        <div class="form-group">
                            <label for="pathological_diseases"> {{ trans('patients/admin_lang.fields.pathological_diseases') }}</label>
                ...
                <div class="row form-group mb-3">     
                    <div class="col-lg-12">                     
                        <div class="form-group">
                            <label for="surgical_diseases"> {{ trans('patients/admin_lang.fields.surgical_diseases') }}</label>
                ...
                <div class="row form-group mb-3">     
                    <div class="col-lg-12">                     
                        <div class="form-group">
                            <label for="family_history"> {{ trans('patients/admin_lang.fields.family_history') }}</label>
                ...
                <div class="row form-group mb-3">     
                    <div class="col-lg-12">                     
                        <div class="form-group">
                            <label for="gynecological_history"> {{ trans('patients/admin_lang.fields.gynecological_history') }}</label>
                ...
                <div class="row form-group mb-3">     
                    <div class="col-lg-12">                     
                        <div class="form-group">
                            <label for="others"> {{ trans('patients/admin_lang.fields.others') }}</label>
