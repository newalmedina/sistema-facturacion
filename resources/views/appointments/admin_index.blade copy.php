                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" multiple name="state[]" id="state">
                                        ...
                                        <option value="{{ $key }}" @if(in_array($key,$filtState)) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" multiple name="service_id[]" id="service_id">
                                        ...
                                        <option value="{{  $service->id }}" @if(in_array($service->id,$filtServiceId))
                                            selected
                                            @endif
                                            >{{ $service->name }}</option>
                                        @endforeach
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" multiple name="user_id[]" id="user_id">
                                        ...
                                        <option value="{{  $patient->id }}" @if(in_array($patient->id,$filtUserId))
                                            selected
                                            @endif
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" multiple name="doctor_id[]" id="doctor_id">
                                        ...
                                        <option value="{{  $doctor->id }}" @if(in_array($doctor->id,$filtDoctorId))
                                            selected
                                            @endif
