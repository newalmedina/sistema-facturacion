      ...
      <div class="col-md-4 col-lg-3 mb-4 mb-lg-0">
        ...
        <div class="feature-box feature-box-style-2 align-items-center mb-3">
          <div class="feature-box-icon">
            <img class="icon-animated" width="45" src="{{ asset('assets/front/img/demos/cleaning-services/icons/phone.svg')}}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" />
          </div>
      ...
      <div class="row py-4 mt-2">
        <div class="col-lg-6 text-center text-lg-start mb-3 mb-lg-0">
          <a href="demo-cleaning-services.html">
            <img alt="Porto" width="115" height="30" src="{{ asset('assets/front/img/demos/cleaning-services/logo-light.png')}}">
          </a>
        </div>
        <div class="col-lg-6 text-center text-lg-end">
          <p class="text-3 mb-0">Porto Cleaning Services. © 2021. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </div>
