                    ...
                    <div class="card-body">  
                        <div class="text-end">
                            @if(Auth::user()->isAbleTo("admin-diagnosis-create"))
                              <a href="{{ url('admin/diagnosis/create') }}" class="btn btn-outline-success">
                                {{ trans('diagnosis/admin_lang.new') }}
                              </a>
                            @endif
                          </div>
                    </div>
                ...
                <div class="col">
                    <section class="card card-featured-top card-featured-primary">
                        ...
                        <div class="card-body">  
                            <div class="row">
                                <div class="col-12 ">
                                    <a href="{{ url('admin/diagnosis/export-excel') }}" class="text-success">
...
<script>
    ...
    @if ( Auth::user()->isAbleTo("admin-diagnosis-list") )    
        ...
        function changeState(id){
            $.ajax({
                url     : "{{ url('admin/diagnosis/change-state/') }}/"+id,
                type    : 'GET',
