                  ...
                  <div class="row form-group mb-3">
                    <div class="col-md-4">                     
                        <div class="form-group">
                            <label for="start_date"> {{ trans('patient-medical-studies/admin_lang.fields.start_date') }}<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">                     
                        <div class="form-group">
                            <label for="end_date"> {{ trans('patient-medical-studies/admin_lang.fields.end_date') }}<span class="text-danger">*</span></label>
