            ...
            <div class="card-body">
                <div class="row form-group mb-3">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <label for="MAIL_MAILER"> {!! trans('settings/admin_smtp_lang.fields.MAIL_MAILER') !!}<span class="text-danger">*</span></label>
                ...
                <div class="row form-group mb-3">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="MAIL_HOST"> {!! trans('settings/admin_smtp_lang.fields.MAIL_HOST') !!}<span class="text-danger">*</span></label>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="form-group">
                            <label for="MAIL_ENCRYPTION"> {!! trans('settings/admin_smtp_lang.fields.MAIL_ENCRYPTION') !!}<span class="text-danger">*</span></label>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="form-group">
                            <label for="MAIL_PORT"> {!! trans('settings/admin_smtp_lang.fields.MAIL_PORT') !!}<span class="text-danger">*</span></label>
                ...
                <div class="row form-group mb-3">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="MAIL_USERNAME"> {{ trans('settings/admin_smtp_lang.fields.MAIL_USERNAME') }}<span class="text-danger">*</span></label>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="MAIL_PASSWORD"> {{ trans('settings/admin_smtp_lang.fields.MAIL_PASSWORD') }}<span class="text-danger">*</span></label>
                ...
                <div class="row form-group mb-3">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="MAIL_FROM_ADDRESS"> {!! trans('settings/admin_smtp_lang.fields.MAIL_FROM_ADDRESS') !!}<span class="text-danger">*</span></label>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="MAIL_FROM_NAME"> {!! trans('settings/admin_smtp_lang.fields.MAIL_FROM_NAME') !!}<span class="text-danger">*</span></label>
                ...
                <div class="row form-group mb-3">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <label for="active"> {!! trans('settings/admin_smtp_lang.fields.MAIL_SEND_ACTIVE') !!}</label>
