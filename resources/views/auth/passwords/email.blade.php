    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 align-self-center p-static order-2 text-center">
                <h1 class="font-weight-bold text-dark">Recuperar contraseña</h1>
            </div>
               ...
               <div class="row">
                <div class="col">
                    <div class="form-group col-md-auto">
                        <a class="text-decoration-none text-color-dark text-color-hover-primary font-weight-semibold text-2" href="{{ url('login') }}">
                           ¿Ya recuerda su contraseña? inicie sesión</a>
                    </div>
                </div>
               </div>
                <div class="row">
