                    ...
                    <div class="card-body">  
                        <div class="text-end">
                            @if(Auth::user()->isAbleTo("admin-roles-create"))
                              <a href="{{ url('admin/roles/create') }}" class="btn btn-outline-success">
                                {{ trans('roles/admin_lang.new') }}
                              </a>
                            @endif
                          </div>
                    </div>
                    <div class="card-body">      
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                ...
                                <table id="table_roles" class="table table-bordered table-striped" style="width: 100%" aria-hidden="true">
                                    <thead>
                                        <tr>
                                            {{-- <th scope="col"> --}}
                                            <th scope="col">
...
<script>
    ...
    @if ( Auth::user()->isAbleTo("admin-roles-list") )    
        $(function() {
            ...
            /* order: [
                ...
                columns: [
                    ...
                    {
                        "title": "{!! trans('roles/admin_lang.fields.description') !!}",
                        orderable: true,
                        searchable: true,
                        data: 'description',
        ...
        function changeState(id){
            $.ajax({
                url     : "{{ url('admin/roles/change-state/') }}/"+id,
                type    : 'GET',
