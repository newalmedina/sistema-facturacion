                    ...
                    <div class="card-body">  
                        <div class="text-end">
                            @if(Auth::user()->isAbleTo("admin-medical-specializations-create"))
                              <a href="{{ url('admin/medical-specializations/create') }}" class="btn btn-outline-success">
                                {{ trans('medical-specializations/admin_lang.new') }}
                              </a>
                            @endif
                          </div>
                    </div>
                ...
                <div class="col">
                    <section class="card card-featured-top card-featured-primary">
                        ...
                        <div class="card-body">  
                            <div class="row">
                                <div class="col-12 ">
                                    <a href="{{ url('admin/medical-specializations/export-excel') }}" class="text-success">
...
<script>
    ...
    @if ( Auth::user()->isAbleTo("admin-medical-specializations-list") )    
        $(function() {
            oTable = $('#table_users').DataTable({
                ...
                ajax: {
                    ...
                    url: "{{ url('admin/medical-specializations/list') }}",
                    type: "POST"
                },
            /* order: [
                    [2, "asc"]
                ...
                columns: [
                    ...
                    {
                        "title": "{!! trans('medical-specializations/admin_lang.fields.name') !!}",
                        orderable: true,
                        searchable: true,
                        data: 'name',
        ...
        function changeState(id){
            $.ajax({
                url     : "{{ url('admin/medical-specializations/change-state/') }}/"+id,
                type    : 'GET',
