                  ...
                  <div class="row form-group mb-3">
                    <div class="col-md-4">                     
                        <div class="form-group">
                            <label class='text-primary' for="start_date"> {{ trans('patient-monitorings/admin_lang.fields.start_date') }}</label>
                            <input value="{{ $filtStartData }}" name="start_date" type="text"  autocomplete="off" class="form-control datepicker"   placeholder="{{ trans('patient-monitorings/admin_lang.fields.start_date_helper') }}">
                        </div>
                    </div>
                    <div class="col-md-4">                     
                        <div class="form-group">
                            <label class='text-primary' for="end_date"> {{ trans('patient-monitorings/admin_lang.fields.end_date') }}</label>
                            <input value="{{ $filtEndData }}" name="end_date" type="text"  autocomplete="off" class="form-control datepicker"   placeholder="{{ trans('patient-monitorings/admin_lang.fields.end_date_helper') }}">
                        </div>
                    </div>
                  </div>
                    <div class="row form-group mb-3">
                        <div class="col-12 col-md-8">                     
                            <div class="form-group">
                                <label class='text-primary' for="center_id"  class="col-12"> {{ trans('patient-monitorings/admin_lang.fields.centers') }}</label>
